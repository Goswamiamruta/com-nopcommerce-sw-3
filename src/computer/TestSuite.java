...
public class TestSuite extends Utility {
    ...
    public void verifyProductArrangeInAlphaBaticalOrder() {
        ...
        clickOnElement(xpath("//a[@href='/computers']"));

        //1.2 Click on Desktop
        clickOnElement(xpath("//img[@alt='Picture for category Desktops']"));

        //1.3 Select Sort By position "Name: Z to A"
        selectByVisibleTextFromDropdown(name("products-orderby"), "Name: Z to A");

        //1.4 Verify the Product will arrange in Descending order.
        verifyElements("error", "Name: Z to A", xpath("//option[contains(text(),'Name: Z to A')]"));
    }
    ...
    public void verifyProductAddedToShoppingCartSuccessFully() throws InterruptedException {
        ...
        selectByVisibleTextFromDropdown(name("products-orderby"), "Name: A to Z");
        Thread.sleep(1000);
        ...
        sendTextToElement(By.id("BillingNewAddress_FirstName"), "Amruta");
        sendTextToElement(By.id("BillingNewAddress_LastName"), "Goswami");
        sendTextToElement(By.id("BillingNewAddress_Email"), "amruta12@gmail.com");
        ...
        sendTextToElement(By.id("BillingNewAddress_ZipPostalCode"), "Ha39Tf");
        ...
        sendTextToElement(By.id("CardholderName"), "Amruta");
